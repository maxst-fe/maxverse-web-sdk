...
import { AuthorizationOptions, OnLoad, Passport, PassportClientOptions } from '@maxverse/passport-web-sdk';
...
export const getPassportInstance = (clientOptions?: PassportClientOptions & { onLoad?: OnLoad }) => {
